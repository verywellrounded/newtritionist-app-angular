...
var ɵAngularFireSchedulers = class _ɵAngularFireSchedulers {
  ...
  static ɵfac = function ɵAngularFireSchedulers_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ɵAngularFireSchedulers)(ɵɵinject(NgZone), ɵɵinject(PendingTasks));
  };
...
var zoneWrapFn = (it, taskDone) => {
  return (...args) => {
    if (taskDone) {
      setTimeout(taskDone, 10);
    }
    return run(() => it.apply(void 0, args));
  };
};
  ...
  return function() {
    ...
    if (ret instanceof Observable) {
      ...
      return run(() => new Promise((resolve, reject) => {
        ret.then((it2) => run(() => resolve(it2)), (reason) => run(() => reject(reason)));
      }));
...
firebase/app/dist/esm/index.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-J4OPELNQ.js.map
